...
$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),setTimeout(function(){$(".ug-slide2 .ug-button-videoplay.ug-type-square").trigger("click")},1e3),$(function(){function e(e,t){e.click(function(e){e.preventDefault(),$("body,html").animate({scrollTop:t.offset().top},450)})}jQuery.browser={},jQuery.browser.mozilla=/mozilla/.test(navigator.userAgent.toLowerCase())&&!/webkit/.test(navigator.userAgent.toLowerCase()),jQuery.browser.webkit=/webkit/.test(navigator.userAgent.toLowerCase()),jQuery.browser.opera=/opera/.test(navigator.userAgent.toLowerCase()),jQuery.browser.msie=/msie/.test(navigator.userAgent.toLowerCase()),jQuery.browser.webkit&&$(".projects-audience-list .big").css("width","120");var t=$(window).width(),i=$(".container").width(),r=$("#gallery img").length;$("#gallery").unitegallery;if($("#gallery").unitegallery({theme_load_panel:1!=r,theme_panel_position:t<769?"bottom":"right",thumb_width:t<769?139:175,thumb_height:t<769?93:120,slider_enable_text_panel:!1,gallery_width:1081,gallery_height:594,strip_space_between_thumbs:t<769?10:30,strip_control_avia:!1,strippanel_padding_top:0,strippanel_padding_bottom:0,strippanel_padding_left:t<769?0:8,strippanel_padding_right:t<769?0:8,slider_control_swipe:!1,slider_control_zoom:!1,slider_enable_arrows:!1,slider_enable_fullscreen_button:!1,slider_enable_zoom_panel:!1}),$(".popup-img").lightGallery({selector:"this",counter:!1,showAfterLoad:!1}),$(".popup-pdf").lightGallery({selector:"this",iframeMaxWidth:"95%",counter:!1,zoom:!1,showAfterLoad:!1}),$(".banner-articles-wrapper .bxslider").bxSlider({mode:"fade",controls:!1,oneToOneTouch:!0}),$(".date-v4.bxslider").bxSlider({mode:"fade",controls:!1,oneToOneTouch:!0,wrapperClass:"date-v4 bx-wrapper"}),$(".banner-footer-carousel .bxslider").bxSlider({mode:"horizontal",maxSlides:t<481?1:t>480&&t<769?3:t>768&&t<993?5:6,infiniteLoop:!1,prevText:"",nextText:"",slideWidth:t<480?480:t>480&&t<769?i/3:t>768&&t<993?i/5:(i-100)/6,pagerType:"short",pagerShortSeparator:"/",pager:!(t<993)}),$(".reviews-audience-company-slider .bxslider").bxSlider({mode:"horizontal",maxSlides:t<481?1:t>480&&t<769?3:t>768&&t<993?5:6,infiniteLoop:!1,prevText:"",nextText:"",slideWidth:t<480?480:t>480&&t<769?i/3:t>768&&t<993?i/5:i/6,pagerType:"short",pagerShortSeparator:"/"}),$(".reviews-audience-text-slider .bxslider").bxSlider({mode:"horizontal",controls:!1,infiniteLoop:!1,minSlides:1,maxSlides:2,prevText:"",nextText:"",slideWidth:t<993&&t>768?(i-65)/2:t<769?768:(i-100)/2,slideMargin:t<993?65:100,adaptiveHeight:!0}),$(".photo-project-slider .bxslider").bxSlider({mode:"horizontal",infiniteLoop:!1,controls:!0,maxSlides:t<769&&t>480?2:t<481?1:3,prevText:"",nextText:"",slideWidth:t<993&&t>768?(i-27)/3:t<769&&t>480?(i-27)/2:t<481?480:(i-27)/3,pagerType:"short",pagerShortSeparator:"/",slideMargin:27}),$(".thumbnails a").click(function(e){e.preventDefault(),$(".player").each(function(){this.pause()})}),$(".bxslider").bxSlider({mode:"fade",captions:!0,slideWidth:700,prevText:"",nextText:""}),function(e){var t=0;$(e).each(function(e){$(this).height()>t&&(t=$(this).height())}),e.height(t)}($(".bxslider .item")),$(".main-menu-button").click(function(){$(".main-mobile-menu").slideToggle(),$(".main-menu-button").toggleClass("close")}),$(".audience-menu .arrow").click(function(e){e.preventDefault(),$(".audience-menu ul li").not(".arrow").slideToggle(),$(".audience-menu li.arrow").toggleClass("rotate")}),$(".return-form").click(function(e){e.preventDefault(),$(".callback_done").fadeOut(250),setTimeout(function(){$(".callback-wrapper").fadeIn(250)},250)}),$("*").is(".audience-menu"))var o=+$(".audience-menu").offset().top;$(window).scroll(function(){$(this).scrollTop()>=o?($(".audience-menu").addClass("sticky"),$(".header-top-line").addClass("margin")):($(".audience-menu").removeClass("sticky"),$(".header-top-line").removeClass("margin"))}),e($('.main-navigation a[href="#reviews"]'),$(".banner-footer")),e($('.main-navigation a[href="#project"]'),$(".our-project .our-project-title")),$(".contacts-wrap").liteAccordion({containerWidth:360,containerHeight:30,firstSlide:2,theme:""}).find(".contact-text:first").hide(0)});