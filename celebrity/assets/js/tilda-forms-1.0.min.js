! function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof exports ? t(require("jquery")) : t(jQuery) }(function(F) {
    var a, t = navigator.userAgent,
        k = /iphone/i.test(t),
        o = /chrome/i.test(t),
        _ = /android/i.test(t);
    F.mask = { definitions: { 9: "[0-9]", a: "[A-Za-z]", "а": "[А-Яа-яЁё]", "*": "[A-Za-zА-Яа-яЁё0-9]" }, autoclear: !0, dataName: "rawMaskFn", placeholder: "_" }, F.fn.extend({
        caret: function(t, e) { var r; if (0 !== this.length && !this.is(":hidden") && this.get(0) === document.activeElement) return "number" == typeof t ? (e = "number" == typeof e ? e : t, this.each(function() { this.setSelectionRange ? this.setSelectionRange(t, e) : this.createTextRange && ((r = this.createTextRange()).collapse(!0), r.moveEnd("character", e), r.moveStart("character", t), r.select()) })) : (this[0].setSelectionRange ? (t = this[0].selectionStart, e = this[0].selectionEnd) : document.selection && document.selection.createRange && (r = document.selection.createRange(), t = 0 - r.duplicate().moveStart("character", -1e5), e = t + r.text.length), { begin: t, end: e }) },
        unmask: function() { return this.trigger("unmask") },
        mask: function(e, y) {
            var r, g, v, j, b, $, x;
            if (!e && 0 < this.length) { var t = F(this[0]).data(F.mask.dataName); return t ? t() : void 0 }
            return y = F.extend({ autoclear: F.mask.autoclear, placeholder: F.mask.placeholder, completed: null }, y), r = F.mask.definitions, g = [], v = $ = e.length, j = null, e = String(e), F.each(e.split(""), function(t, e) { "?" == e ? ($--, v = t) : r[e] ? (g.push(new RegExp(r[e])), null === j && (j = g.length - 1), t < v && (b = g.length - 1)) : g.push(null) }), this.trigger("unmask").each(function() {
                var n = F(this),
                    s = F.map(e.split(""), function(t, e) { if ("?" != t) return r[t] ? c(e) : t }),
                    d = s.join(""),
                    i = n.val();
                ...
                function m(t) { for (; ++t < $ && !g[t];); return t }
                ...
                function f(t, e) { var r; for (r = t; r < e && r < $; r++) g[r] && (s[r] = c(r)) }
                    ...
                    for (a = e = 0; e < $; e++)
                        if (g[e]) {
                            for (s[e] = c(e); a++ < o.length;)
                                if (r = o.charAt(a - 1), g[e].test(r)) { s[e] = r, i = e; break } if (a > o.length) { f(e + 1, $); break }
                        } else s[e] === o.charAt(a) && a++, e < v && (i = e);
                    return t ? w() : i + 1 < v ? y.autoclear || s.join("") === d ? (n.val() && n.val(""), f(0, $)) : w() : (w(), n.val(n.val().substring(0, i + 1))), v ? e : j
                }
                n.data(F.mask.dataName, function() { return F.map(s, function(t, e) { return g[e] && t != c(e) ? t : null }).join("") }), n.one("unmask", function() { n.off(".mask").removeData(F.mask.dataName) }).on("focus.mask", function() {
                    var t;
                    n.prop("readonly") || (clearTimeout(a), i = n.val(), t = h(), a = setTimeout(function() { n.get(0) === document.activeElement && (w(), t == e.replace("?", "").length ? n.caret(0, t) : n.caret(t)) }, 10))
                }).on("blur.mask", p).on("keydown.mask", function(t) {
                    if (!n.prop("readonly")) {
                        var e, r, a, o = t.which || t.keyCode;
                        x = n.val(), 8 === o || 46 === o || k && 127 === o ? (r = (e = n.caret()).begin, (a = e.end) - r == 0 && (r = 46 !== o ? function(t) { for (; 0 <= --t && !g[t];); return t }(r) : a = m(r - 1), a = 46 === o ? m(a) : a), f(r, a), u(r, a - 1), t.preventDefault()) : 13 === o ? p.call(this, t) : 27 === o && (n.val(i), n.caret(0, h()), t.preventDefault())
                    }
                        ...
                        if (!(t.ctrlKey || t.altKey || t.metaKey || o < 32) && o && 13 !== o) {
                            if (i.end - i.begin != 0 && (f(i.begin, i.end), u(i.begin, i.end - 1)), (e = m(i.begin - 1)) < $ && (r = String.fromCharCode(o), g[e].test(r))) {
                                if (! function(t) {
                                    ...
                                    }(e), s[e] = r, w(), a = m(e), _) { setTimeout(function() { F.proxy(F.fn.caret, n, a)() }, 0) } else n.caret(a);
                                i.begin <= b && l()
                            }
                            t.preventDefault()
                        }
    ...
    window.tildaBrowserLang = window.navigator.userLanguage || window.navigator.language, window.tildaBrowserLang = window.tildaBrowserLang.toUpperCase(), -1 != window.tildaBrowserLang.indexOf("RU") ? window.tildaBrowserLang = "RU" : window.tildaBrowserLang = "EN", window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.tildaForm = { versionLib: "01.001", endpoint: "forms.tildacdn.com", isRecaptchaScriptInit: !1, currentFormProccessing: !1, arMessages: { EN: { success: "Thank you! Your data has been submitted.", successorder: "Thank you! Order created. Please wait. We are going to the payment..." }, RU: { success: "Спасибо! Данные успешно отправлены.", successorder: "Спасибо! Заказ оформлен. Пожалуйста, подождите. Идет переход к оплате...." } }, arValidateErrors: { EN: { email: "Please put a correct e-mail", url: "Please put a correct URL", phone: "Please put a correct phone number", number: "Please put a correct number", date: "Please put a correct date", time: "Please put a correct time (HH:mm)", name: "Please put a name", namerus: "Please put a correct name (only cyrillic letters)", nameeng: "Please put a correct name (only latin letters)", string: "You put incorrect symbols. Only letters, numbers and punctuation symbols are allowed", req: "Please fill out all required fields", reqfield: "Required field", minlength: "Value is too short", maxlength: "Value too big", emptyfill: "None of the fields are filled in", chosevalue: "Please select an address from the options" }, RU: { email: "Укажите, пожалуйста, корректный email", url: "Укажите, пожалуйста, корректный URL", phone: "Укажите, пожалуйста, корректный номер телефона", number: "Укажите, пожалуйста, корректный номер", date: "Укажите, пожалуйста, корректную дату", time: "Укажите, пожалуйста, корректное время (ЧЧ:ММ)", name: "Укажите, пожалуйста, имя", namerus: "Укажите, пожалуйста, имя (только кириллица)", nameeng: "Укажите, пожалуйста, имя (только латиница)", string: "Вы написали некорректные символы. Разрешены только буквы, числа и знаки пунктуации", req: "Пожалуйста, заполните все обязательные поля", minlength: "Слишком короткое значение", maxlength: "Слишком длинное", reqfield: "Обязательное поле", emptyfill: "Ни одно поле не заполнено", chosevalue: "Пожалуйста, выберите адрес из предложенных вариантов" } } }, $(document).ready(function() {
        window.tildaForm.captchaCallback = function(t) {
            ...
            return t.find(".js-tilda-rule").each(function() {
                var t, e, r = $(this).data("tilda-req") || 0,
                    ...
                    s = $(this).val(),
                    d = "";
                if (n.obj = $(this), n.type = [], s && 0 < s.length) { try { d = s.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, "") } catch (t) {} s = s.trim() }
                if (0 < s.length && (m = !1), o = o && parseInt(o), i = i && parseInt(i), 1 == r && (0 == s.length && 0 == d.length || ("checkbox" == $(this).attr("type") || "radio" == $(this).attr("type")) && 0 == $(this).closest("form").find('[name="' + $(this).attr("name") + '"]:checked').length)) n.type.push("req");
                else {
                    switch (a) {
                        case "email":
                        ...
                        case "string":
                            ...
                            break;
                        case "chosevalue":
                            var l = "true" === $(this).attr("data-option-selected");
                            console.log(l), l || n.type.push("chosevalue")
                    }
            ...
            }), m && 0 == c.length && (c = [{ obj: "none", type: ["emptyfill"] }]), c
            ...
            for (var a, o, i, n = window.tildaForm.arValidateErrors[window.tildaBrowserLang] || {}, s = "", d = 0; d < e.length; d++)
                if (e[d] && e[d].obj) {
                    ...
                    for ((o = 0) < (a = e[d].obj.closest(r).addClass("js-error-control-box")).find(".t-input-error").length && (o = 1), j = 0; j < e[d].type.length; j++) error = e[d].type[j], s = "", 0 < (i = t.find(".js-rule-error-" + error)).length ? ("" == i.text() && "" < n[error] ? i.html(n[error]) : s = i.eq(0).text(), i.css("display", "block").show()) : "" < n[error] && (i = t.find(".js-rule-error-all")) && 0 < i.length && (i.html(n[error]), i.css("display", "block").show()), o && ("" == s && ("" < n[error + "field"] ? s = n[error + "field"] : "" < n[error] && (s = n[error])), "" < s && a.find(".t-input-error").html(s))
            ...
            try { r = (new Date).getTime() + "=" + parseInt(8 * Math.random()) } catch (t) { r = "rnd=" + parseInt(8 * Math.random()) } $("body").append('<div id="tildaformcaptchabox" style="z-index:10000000;position:fixed; text-align: center; vertical-align: middle; top: 0px; left:0px; bottom: 0px; right: 0px; background: rgba(255,255,255,0.97);"><iframe id="captchaIframeBox" src="//' + window.tildaForm.endpoint + "/procces/captcha/?tildaspec-formid=" + t.attr("id") + "&tildaspec-formskey=" + e + "&" + r + '" frameborder="0" width="100%" height="100%"></iframe></div>'), window.removeEventListener("message", checkVerifyTildaCaptcha), window.addEventListener("message", checkVerifyTildaCaptcha)
            ...
            window.tcart.delivery && window.tcart.delivery.name && (window.tildaForm.tildapayment.delivery = { name: window.tcart.delivery.name }, window.tcart.delivery && window.tcart.delivery.price && (pricedelivery = window.tcart.delivery.price, window.tildaForm.tildapayment.delivery.price = window.tcart.delivery.price, 0 < window.tcart.prodamount && void 0 !== window.tcart.delivery.freedl && 0 < window.tcart.delivery.freedl && (window.tildaForm.tildapayment.delivery.freedl = window.tcart.delivery.freedl, window.tcart.prodamount - o >= window.tcart.delivery.freedl && (pricedelivery = 0)), s = { name: window.tcart.delivery.name, price: pricedelivery, quantity: 1, id: "delivery" }, window.tildaForm.arProductsForStat.push(s)));
            try {
                ["city", "street", "pickup-name", "pickup-address", "pickup-id", "house", "entrance", "floor", "aptoffice", "phone", "entrancecode", "comment", "service-id", "hash", "postalcode", "country"].forEach(function(t) { window.tcart.delivery && window.tcart.delivery[t] && (window.tildaForm.tildapayment.delivery[t] = window.tcart.delivery[t]) })
            } catch (t) { console.log(t) } t.append("")
        }, window.tildaForm.clearTCart = function(t) {
            if ("y" == t.data("formcart")) {
                if (window.tcart = { amount: 0, currency: "", system: "", products: [] }, window.tcart.system = "none", "object" == typeof localStorage) try { localStorage.removeItem("tcart") } catch (t) { console.log("Your web browser does not support localStorage.") }
                try { delete window.tcart, tcart__loadLocalObj() } catch (t) {} window.tcart_success = "yes"
            }
            ...
            if ("y" != $jform.data("formpaymentoff")) {
                ...
                } else { if ("function" == arNext.type) { var arArgs = arNext.value.args; return arNext.value.functioncode ? tildaForm.paysystemRun(arNext.value.script, arNext.value.sysname, $jform, arNext.value.functioncode, arArgs) : eval(arNext.value.name + "($jform, arArgs);"), !1 } tildaForm.clearTCart($jform), "text" == arNext.type && arNext.message && "" < arNext.message && 0 < $jform.find(".js-successbox").length && ($jform.find(".js-successbox").html(arNext.message), $jform.find(".js-successbox").show()) }
            ...
            if (!0 !== window.stripeapiiscalled) return window.tildaForm.stripeLoad(), window.setTimeout(function() { window.tildaForm.stripePay(n, s) }, 200), !1;
            var t = s.companyname,
                e = s.companylogo;
            if (t = t || window.location.host, !window.stripehandler) {
                if ("object" != typeof window.StripeCheckout) return window.setTimeout(function() { window.tildaForm.stripePay(n, s) }, 200), !1;
                var r = { key: s.accountid, image: e, name: t, locale: "auto" };
                s.zipCode && 1 == s.zipCode && (r.zipCode = !0), s.billingAddress && 1 == s.billingAddress && (r.billingAddress = !0), s.shipping && 1 == s.shipping && (r.shippingAddress = !0), window.stripehandler = window.StripeCheckout.configure(r), $(window).on("popstate", function() { window.stripehandler.close() })
            }
            window.tildaForm.orderIdForStat = s.invoiceid;
            var a = 100;
            try { s.multiple && 0 < s.multiple && (a = parseInt(s.multiple)) } catch (t) {} window.stripehandler.open({
                name: t,
                image: e,
                ...
                token: function(t, e) {
                    t && t.id && $.ajax({
                        ...
                        data: { projectid: s.projectid, invoiceid: s.invoiceid, token: t.id, email: t.email, currency: s.currency, amount: parseInt(parseFloat(s.amount) * a) },
                        dataType: "json",
                        ...
                        success: function(t) {
                            ...
                            "" < s.successurl && window.setTimeout(function() { window.location.href = s.successurl }, 300), "" < n.data("successmessage") ? n.find(".js-successbox").html(n.data("successmessage")) : n.find(".js-successbox").html(""), n.data("successmessage", "");
            ...
            if (!0 !== window.cloudpaymentsapiiscalled) return window.tildaForm.cloudpaymentLoad(), window.setTimeout(function() { window.tildaForm.cloudpaymentPay(n, s) }, 200), !1;
            var d = s.currency,
                t = s.language,
                e = {};
            if (t = t || ("RUB" == d || "BYR" == d || "BYN" == d || "RUR" == d ? "ru-RU" : "UAH" == d ? "uk" : "en-US"), !window.cloudpaymentshandler) {
                if ("object" != typeof window.cp) return window.setTimeout(function() { window.tildaForm.cloudpaymentPay(n, s) }, 200), !1;
                e = { language: t }, s.applePaySupport && "off" == s.applePaySupport && (e.applePaySupport = !1), s.googlePaySupport && "off" == s.googlePaySupport && (e.googlePaySupport = !1), window.cloudpaymentshandler = new cp.CloudPayments(e)
            }
            var r = {};
            ...
            return l && 0 != l.length || (l = n.closest(".t706__cartwin_showed")), l.data("old-style", l.attr("style")), l.attr("style", "z-index:100"), window.tildaForm.orderIdForStat = s.invoiceId, s.skin || (s.skin = "classic"), window.cloudpaymentshandler.charge({ publicId: s.publicId, description: s.description, amount: parseFloat(s.amount), currency: d, accountId: s.accountId, invoiceId: s.invoiceId, requireEmail: 1 == s.requireEmail, email: s.email, skin: s.skin, data: r }, function(t) {
                ...
                else { l.find(".t706__cartwin-products").show(), l.find(".t706__cartwin-prodamount-wrap").show(), l.find(".t706__form-bottom-text").show(), n.find(".t-form__inputsbox").show(); try { tcart__lockScroll() } catch (t) {} }
            }), !1
            ...
            successcallback && 0 < successcallback.length && eval(successcallback + "($jform)"), $jform.find("input[type=text]:visible").val(""), $jform.find("textarea:visible").html(""), $jform.find("textarea:visible").val(""), $jform.data("tildaformresult", { tranid: "0", orderid: "0" }), $jform.trigger("tildaform:aftersuccess")
        }, window.tildaForm.banktransferPay = function(e, r) {
            if (r && "fast" == r.condition) window.tildaForm.sendStatAndShowMessage(e, r, !0);
            else if (r && "" < r.html) {
                $("#allrecords").append(r.html), $(".t-banktransfer .t-popup__close").off("click"), $(".t-banktransfer .t-popup__close").click(function() { $("body").removeClass("t-body_popupshowed"), $(".t-banktransfer").remove(); try { "function" == typeof tcart__closeCart && tcart__closeCart() } catch (t) {} return !1 }), $("body").addClass("t-body_popupshowed");
                ...
                0 < o.length && (o.off("submit"), o.find(".t-submit").off("click"), o.find(".t-submit").off("dblclick"), o.submit(function(t) {
                    ...
                    $.ajax({
                        ...
                        xhrFields: { withCredentials: !1 },
                        success: function(t) {
                            if ($("body").removeClass("t-body_popupshowed"), o.closest(".t-banktransfer").remove(), (t = t || { error: "Unknown error. Please reload page and try again later." }) && t.error) return alert(t.error), !1;
            ...
            $jform.addClass("js-send-form-success"), successcallback && 0 < successcallback.length ? eval(successcallback + "($jform)") : successurl && 0 < successurl.length && setTimeout(function() { window.location.href = successurl }, 500), tildaForm.clearTCart($jform), $jform.find("input[type=text]:visible").val(""), $jform.find("textarea:visible").html(""), $jform.find("textarea:visible").val(""), $jform.data("tildaformresult", { tranid: "0", orderid: "0" })
        ...
        0 < $jallforms.length && $jallforms.each(function() { 1 != $(this).data("formactiontype") && $(this).append('<div style="position: absolute; left: -5000px; bottom:0;"><input type="text" name="form-spec-comments" value="Its good" class="js-form-spec-comments"  tabindex="-1" /></div>') }), $(".r").find(".js-form-procces").each(function() { try { 2 == $(this).data("formactiontype") && $(this).attr("action", "#") } catch (t) { console.log(t) } }), $(".r").off("submit", ".js-form-proccess"), $(".r").on("submit", ".js-form-proccess", function(t) {
            ...
            if (0 < a.find(".g-recaptcha").length && grecaptcha) {
                window.tildaForm.currentFormProccessing = { form: a, btn: e, formtype: o, formskey: i };
                var d = a.data("tilda-captcha-clientid");
                if (void 0 === d || "" === d) {
                    var l = { size: "invisible", sitekey: a.data("tilda-captchakey"), callback: window.tildaForm.captchaCallback };
